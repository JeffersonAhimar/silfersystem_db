<!DOCTYPE html>
<html lang="en">
<?php $titleTable = 'Deposito de Factura' ?>
...
<head>
    ...
    <!-- JS - jQuery - AJAX -->
    <script src="<?php echo web_root; ?>public/javascripts/s_deposito.js"></script>
        ...
        <table id="tblData" class="display responsive nowrap table table-bordered" style="width:100%">
            <thead>
                <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                    ...
                    <th class="px-1 py-1 text-center" width="2%">idFactura</th>
            ...
            <tfoot>
                <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                    <th class="px-1 py-1 text-center" width="3%">id</th>
                    <th class="px-1 py-1 text-center">moneda</th>
                    <th class="px-1 py-1 text-center">monto</th>
                    <th class="px-1 py-1 text-center">fecha</th>
                    <th class="px-1 py-1 text-center" width="2%">link</th>
                    <th class="px-1 py-1 text-center" width="2%">idFactura</th>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="" id="new-frm">
                        <!-- CAMPOS -->
                        <input type="hidden" name="idDeposito">
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="idFactura" class="control-label">idFactura</label>
                            <input type="text" class="form-control rounded-0" id="idFactura" name="idFactura">
                        </div>
                        <!-- /CAMPOS -->
                    </form>
                </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="" id="delete-frm">
                        <input type="hidden" name="idDeposito">
                        <p>Estás seguro de eliminar a <b><span name="idDeposito"></span></b>?</p>
                    </form>
                </div>
            </div>
            <div class="modal-footer">
