<!DOCTYPE html>
<html lang="en">
<?php $titleTable = 'Contrato de Servicio' ?>
...
<head>
    ...
    <!-- JS - jQuery - AJAX -->
    <script src="<?php echo web_root; ?>public/javascripts/s_contrato.js"></script>
        ...
        <table id="tblData" class="display responsive nowrap table table-bordered" style="width:100%">
            <thead>
                <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                    ...
                    <th class="px-1 py-1 text-center">fec_ejecucion</th>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="" id="new-frm">
                        ...
                        <div class="mb-2">
                            <label for="fec_ejecucion" class="control-label">fec_ejecucion</label>
                            <input type="date" class="form-control rounded-0" id="fec_ejecucion" name="fec_ejecucion" required>
                        </div>
                        <div class="mb-2">
