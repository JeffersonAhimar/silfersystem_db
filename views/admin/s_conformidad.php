<!DOCTYPE html>
<html lang="en">
<?php $titleTable = 'Conformidad de Entregable' ?>
...
<head>
    ...
    <!-- JS - jQuery - AJAX -->
    <script src="<?php echo web_root; ?>public/javascripts/s_conformidad.js"></script>
        ...
        <table id="tblData" class="display responsive nowrap table table-bordered" style="width:100%">
            <thead>
                <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                    ...
                    <th class="px-1 py-1 text-center" width="2%">idEntregable</th>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="" id="new-frm">
                        <!-- CAMPOS -->
                        <input type="hidden" name="idConformidad">
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="idEntregable" class="control-label">idEntregable</label>
                            <input type="text" class="form-control rounded-0" id="idEntregable" name="idEntregable">
                        </div>
                        <!-- /CAMPOS -->
                    </form>
                </div>
